                        ...
                        <form method="POST" action="{{ route('pasien.store') }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="md:col-span-1">
                                    ...
                                    <input name="tanggal_lahir" type="date" value="{{ old('tanggal_lahir') }}" max="{{ now()->setTimezone('Asia/Jakarta')->subDay()->toDateString() }}" class="mt-2 w-full rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm outline-none focus:ring-2 focus:ring-emerald-100 @error('tanggal_lahir') border-red-400 @enderror" required />
