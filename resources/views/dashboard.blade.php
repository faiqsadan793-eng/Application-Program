            ...
            <header class="h-20 bg-white border-b border-slate-200 px-6 flex items-center justify-between">
                <div class="w-full max-w-xl">
                    <form method="GET" action="{{ route('pasien.index') }}" class="relative">
                        ...
                        <input type="text" name="search" placeholder="Cari nama pasien atau NIK..." class="w-full rounded-2xl border border-slate-200 bg-slate-50 py-3 pl-12 pr-4 text-sm text-slate-900 outline-none transition focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100" />
                    </form>
                </div>
