                                ...
                                <tbody class="divide-y divide-slate-100">
                                    @forelse($rekamMedis as $pasien)
                                        ...
                                        <tr class="transition hover:bg-emerald-50/30">
                                            ...
                                            <td class="px-5 py-4 text-right"><a href="{{ route('rekam-medis-pasien.show', $pasien) }}" class="inline-flex whitespace-nowrap rounded-lg border border-emerald-700 px-3 py-2 text-xs font-semibold text-emerald-700 transition hover:bg-emerald-50">Lihat Detail RM</a></td>
                                        </tr>
                                    @empty
